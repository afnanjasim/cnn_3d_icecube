...
def parse_args():
    ...
    add_arg('--typeofdata' , choices=['regular','hese_cut'] ,default='regular' ,dest='type_of_data' ,help='Is the input data hese cut or regular ?')
...
if __name__=='__main__':
    ...
    ###Extract data #######
    if type_of_data=='hese_cut':
        data_dir='/data0/vpa/data/data_hese_cuts/'
    elif type_of_data=='regular':
        data_dir='/data0/vpa/data/data_regular/'
