...
#     data_cut=None
    ...
    ### Regular data
    t1=time.time()
    f_extract_data(data_folder='regular',save_location=save_data_dir,mode='quick',cut=data_cut)
    t2=time.time()
    print("Time taken in minutes ",(t2-t1)/60.0)

    ### Reserved data ###
    t1=time.time()
    f_extract_data(data_folder='reserved',save_location=save_data_dir,mode='quick',cut=data_cut)
    t2=time.time()
